...
### 4/29 09:30 audit
- 시작 시각: 2026-04-29 09:25 KST (수요일)
- 종료 시각: 2026-04-29 09:35 KST
- 트리거: 사용자 `/tirtir-audit` slash command "organize tasks for the TIRTIR campaign"
- 주간 경계: today=4/29(Wed) → 이번주 4/27(월)~5/3(일), 다음주 5/4(월)~5/10(일)
- 4/22 audit 이후 7일 경과 (4/24 TIRTIR 전사 휴무, 홍유니 휴가 ~4/24 포함)
- 신규 발견:
  - **Complete 11건**: R138 Spring Matcha Klaviyo (이동호 4/21 17:47 발송 + 4/22 Earth Day Drop 추가), R158/R159/R160/R162/R163/R164 Primer Launch Deal (4/27 13:00 일괄 라이브), R174 Glow Gift Festival 기획 (김소형 4/22 10p 기획안+Figma 공유), R185 자사몰 하단 영상 (황아인 4/22 18:38 client thread reply), R209 Meta Audience Segments (이동호 4/25 직접 세팅)
  - **Processing 상향 1건**: R203 GMC 진단 (황아인 4/24 16:40 1차 정리 → 자연님 4/28 18:13 컨펌)
  - **신규 task 15건 (R210-R224)**:
    - R210/R211 Spring Matcha Refresh 4/27~28 종료 (광고 OFF 홍유니 Complete + Shopify 롤백 이동호 Complete) — RC5 분리
    - R212 5/15 AI 샤셰 1차 리스팅 (이동호/황아인, 4/28)
    - R213 4월 말 Tasks 도출 + 5월 진행계획 (이동호, 4/30) — 자연님 명시 요청 P0
    - R214 Shopify→GSheet 자동 연동 검토 (이동호, 5/2) — 홍유니 4/27 22:10 문의
    - R215/R216 Primer Launch Deal 종료/롤백 (광고 홍유니 + Shopify 이동호, ~5/4) — RC5 분리
    - R217~R224 5/15 AI Filter Cushion Sachet 프로모션 9개 sub-task (No Joke Sale 패턴): 기획/디자인/Shopify 세트/Find My Shade SKU 검증/Klaviyo 4종/광고 캠페인/QA/라이브 (5/15 EST 00:00 = KST 13:00)
  - **운영 규칙 변경 4건**:
    - **UTM 통일 (이동호 4/22 20:47 ts 1776858473)**: 모든 캠페인 Tracking Template 유형을 *Final URL Suffix 방식*으로 통일 (Pmax 트래킹 이슈 대응). Google Search/Display/YouTube/Pmax 모두 적용
    - **Glow Gift Festival 기간/할인율 SWAP (자연님 4/23 20:03 ts 1776942192)**: 운영기간 5/1~5/29 (29일), 3단 단순화 20%/25%/30%
    - **Klaviyo SHOP NOW 버튼 컨벤션 (황아인 4/28 17:27 ts 1777364820)**: 4/28 이후 캠페인부터 SHOP NOW 버튼은 이미지 형태 제작 (폰트 12+Bold 우선)
    - **Klaviyo 레퍼런스 사진 저작권 (자연님 4/23 19:21 ts 1776939672)**: 외부 레퍼런스 사진 그대로 사용 금지
- **RC 위반 / 차단 사항: 2건**
  - **시트 batchUpdate BLOCKED (외부 요인)**: gws CLI refresh token 만료 (`Token has been expired or revoked`). `auth login`은 browser interaction 필요로 환경 제약. 시트 업데이트 0건 적용 못함. 11개 Complete + 1개 Processing 상향 + 15개 신규 row 모두 시트에 미반영. EOD 메시지 자체에는 모두 포함하여 팀 트래킹 가능. **다음 audit 전 별도 sheet 동기화(혹은 토큰 재발급) 필요**
  - 운영 규칙 4건 → CLAUDE.md 반영 진행 중 (UTM Final URL Suffix 규칙 + Klaviyo SHOP NOW 버튼 컨벤션 신규 추가)
- 발송 ts: 1777423222.597709 (C0ALWLLQFU7 내부 채널, 확인 없이 자동 발송)
